...
\chapter{Úvod} %{{{
    ...
    omezením v jeho mikrokontroleru.
    ...
    programu pro ovládání e-puck robota. Pro seznámení s knihovnou a možnostmi
    ...
    externími knihovnami. Výsledkem bude jednoduché vytváření grafických
    ...
    vyrovnává. V části \ref{comm-epuck} je popsáno jak vypadá komunikace s
    e-puck robotem z pohledu robota.
    ...
    díky kterým může být situace asynchronní a také mohla být rozšířena
    funkčnost robota.
...
Výsledek je převeden do formátu obrázků pro OpenCV. Dáke je zavolán algoritmus
pro detekci obličejů, ty jsou zakresleny do fotky (zdrojový kód
\ref{opencv_part}).
