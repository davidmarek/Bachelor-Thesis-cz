...
\chapter{Teorie}
    ...
    Každá zpráva je opatřena kódem příkazu a pořadovým číslem zprávy, tedy je
    možné poslat i více stejných zpráv asynchronně (např. několikrát po sobě
    číst hodnotu ze senzorů) a knihovna rozezná jednotlivé zprávy od sebe.
