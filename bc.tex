...
\chapter{Teorie}
    ...
    příklady jsou určeny pro předvedení možných způsobů ovládání robota.
...
\chapter{Implementace}
    ...
    představen firmware BTcom, který je používán pro ovládání robota a jsou zde
    ...
    \ref{async-impl}. Jsou zde představeny mechanismy, díky kterým je možné
