...
\label{chap:teorie}
    ...
    stojí a také bych se rád zmínil o způsobech jak řeší ovládání robota jiní.
    Nejprve je nutné zjistit jaké vlastnosti má robot e-puck, abychom pak dále
    mohli posoudit do jaké míry využíváme jeho předností a také zhodnotit
    ...
    úrovni. Vytvořen byl v EPFL (Ecole Polytechnique Fédérale de Laussanne).
    Celý projekt je založen na konceptu otevřeného hardware, což znamená, že
    ...
    \begin{itemize}
        \item Infračervené (IR) sensory -- po obvodu robota je 8 IR sensorů. Měří
    ...
    čekat, dokud neobdrží zprávu), není problém s nekonzistencí dat (než bude
