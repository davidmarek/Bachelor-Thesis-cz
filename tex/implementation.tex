...
(0,0)
    ...
    na objekt s potenciální odpověďí. Díky tomu se pak může tázat, zda-li
    odpověď přišla a nakonec ji také i získat. Ukázka je ve zdrojovém kódu
    \ref{lst:oddeleni}. Pro vysvětlení jak tento odkaz funguje bude
