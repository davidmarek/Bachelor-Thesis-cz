...
Abstract:
In the present work we study controlling miniature e-Puck robot. We have chosen
to use the Python programming language because it is very easy to use for rapid
development and interactive control. We focus on remote control of the robot
from PC via Bluetooth. Important parts of the remote control are mechanisms
handling robust communication. User can choose between synchronous and
asynchronous communication. The former is primarily used for interactive
controlling thanks to its transparency. The latter is a right choice for
reliable communication. We have also created a few example programs to present
